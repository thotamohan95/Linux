...
```
┌────────────────────────────────────────────┐
│ User Applications (Vim, Docker, Apache)    │
├────────────────────────────────────────────┤
│ Shell (Bash, Zsh, Fish, etc.)              │  ← Part of the OS
├────────────────────────────────────────────┤
│ System Libraries (glibc, libc, OpenSSL)    │  ← Part of the OS
├────────────────────────────────────────────┤
│ System Utilities (ls, grep, systemctl)     │  ← Part of the OS
├────────────────────────────────────────────┤
│ Linux Kernel (Process, Memory, FS, Net)    │  ← Core of the OS
├────────────────────────────────────────────┤
...
Linux distributions (distros) are different versions of Linux that package the Linux kernel with various software, system utilities, and package managers. Each distro is designed for different use cases.
...
| **CentOS** | Previously a popular choice for servers, based on Red Hat Enterprise Linux (RHEL). Now discontinued, replaced by AlmaLinux/Rocky Linux. |
